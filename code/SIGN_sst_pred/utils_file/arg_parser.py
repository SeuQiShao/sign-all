...
def parse_args():
    ...
    parser.add_argument(
        "--activate", type=str, default=False, help="activation of Library."
    )
    ...
    args.root = 'D:/QMcode/sign_github/SIGN_lasso_true_pred/SIGN_data/{}_{}'.format(args.ode_model, args.num_atoms)
