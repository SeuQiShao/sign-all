...
def parse_args():
    ...
    parser.add_argument('--ode_model', type=str,
                    choices=['FHN', 'HR', 'Rossler'], default='HR')
    parser.add_argument('--time_stamp', type=int, default=10000, help="number of timesteps.")
    parser.add_argument('--time_interval', type=float, default=0.02, help="number of sample interval.")
    ...
    args.root = '/data/scratch/acw802/SIGN_lasso_hd_pred/{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp)
